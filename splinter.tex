...
better business decisions. However, the problem is that 
...
Then, the user\footnote{In this dissertation, we use the term "user" broadly
...
We implemented the logic in Olumofin et al., ported our
