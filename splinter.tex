...
because the data might contain proprietary information. However,
researchers would like to perform data analysis without
revealing their parameters, which might leak trade secret
for their algorithms.
For example, data owners like Google Maps and Yelp might allow limited querying
for data analysts through an API but not give complete access to their dataset. 
...
\paragraph{Coverage of supported queries:}
