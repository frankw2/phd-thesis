...
such as traffic data to determine the fastest route.
Similarly, businesses can use this data to better
understand user behavior and perform analytics. 
...
queries to this data can reveal sensitive information,
...
This dissertation presents Splinter, a system that protects users' queries to web applications
